...
# Script để submit job Bronze layer ingest lên Spark cluster Docker

# Tên container Spark Master
...
SCRIPT_PATH="/opt/spark-apps/bronze/bronze_layer_ingest.py"
...
# Submit job sử dụng here-doc cho dễ quản lý quote
echo "==> Submitting Bronze ingestion job to Spark Master: ${MASTER_URL}"
